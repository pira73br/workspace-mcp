...
description: Skill para release, entrega para cliente, PR significativo, MVP, POC ou handoff executivo/técnico com padrão enterprise-grade, evidência objetiva e sem alucinação.
version: 1.4.0
...
## When to use
Use this skill when the task involves release, entrega para cliente, PR significativo, MVP, POC ou handoff executivo/técnico. Apply it when evidence, deterministic execution, enterprise readiness, Git/SemVer, no-workaround discipline or delivery pacing must be reviewed.
