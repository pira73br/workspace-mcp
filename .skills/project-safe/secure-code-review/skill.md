...
version: 1.2.0
description: "Secure Code Review for production-grade agentic delivery"
owner: "hyst / Marcelo Moreira"
---
# Secure Code Review Skill

## When to use
Use this skill when the task requires security-sensitive changes, auth, tenant, secrets, uploads, webhooks or privileged actions. It is intended for production-grade projects using the hyst Agentic Harness, hDS, gold-standard engineering and banking-grade security expectations.
...
## Instructions
Apply threat modeling, input validation, output encoding, least privilege, audit logs, secret handling, tenant isolation and safe error handling.
...
## Outputs
Security review report, required fixes and validation evidence.
