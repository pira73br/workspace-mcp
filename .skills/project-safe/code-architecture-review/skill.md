...
version: 1.2.0
description: "Code Architecture Review for production-grade agentic delivery"
owner: "hyst / Marcelo Moreira"
---
# Code Architecture Review Skill

## When to use
Use this skill when the task requires architecture review, module boundary validation, coupling analysis or design quality assessment. It is intended for production-grade projects using the hyst Agentic Harness, hDS, gold-standard engineering and banking-grade security expectations.
...
## Instructions
Review module boundaries, responsibilities, dependencies, duplication, extension points, API contracts and operability. Check that file sizes follow the code organization policy and that exceptions are justified.
...
## Outputs
Architecture review notes, required changes, risk classification and documentation updates.
